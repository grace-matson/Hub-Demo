...
bucket_name = 'hub-cdap-io/v2'
bucket = storage_client.bucket(bucket_name)
logging.info(storage.Blob(bucket=bucket, name='packages/database-plugin-db2-plugin/1.3.0/db2-plugin-1.3.0.jar').exists(storage_client))
